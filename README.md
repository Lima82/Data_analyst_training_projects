...
- Анализ данных: библиотеки Pandas, Os, NumPy, SciPy, Math, Statsmodels, Datetime, IPython, Sklearn, Scipy, Itertools, Warnings
